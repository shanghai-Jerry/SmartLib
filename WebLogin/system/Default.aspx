...
<body>
    ...
    <div>
       <a href="/Default.aspx">主界面</a> > <a href="Default.aspx">读者类型</a>
    </div>
    <hr />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="borrlimit" HeaderText="借阅上限" />
            <asp:BoundField DataField="conlimit" HeaderText="续借上限" />
